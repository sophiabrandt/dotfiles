...
call minpac#add('autozimu/LanguageClient-neovim', {'rev': 'next', 'do': './install.sh', 'do': ':UpdateRemotePlugins'})
...
call minpac#add('mattn/emmet-vim', {'for': ['javascript.jsx', 'html', 'css']})
call minpac#add('jparise/vim-graphql')
call minpac#add('HerringtonDarkholme/yats.vim')
call minpac#add('mhartington/nvim-typescript', {'do': './install.sh', 'do': ':UpdateRemotePlugins'})
